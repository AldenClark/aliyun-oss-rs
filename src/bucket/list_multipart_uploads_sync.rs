...
impl ListUploadsSync {
    ...
    ///
    /// 发送请求并返回结果。
    pub fn send(self) -> Result<ListMultipartUploadsResult, Error> {
        // Upload file
